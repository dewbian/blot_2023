...
<div id="has-many-{{$column}}" class="has-many-{{$column}}" style="border:0px solid green;">
    ...
    <div class="form-group">
        <label class="{{$viewClass['label']}} control-label"></label>
        <div class="{{$viewClass['field']}}">
            <div class="add btn btn-success btn-sm"><i class="fa fa-save"></i>&nbsp;{{ $label }} {{ trans('admin.new') }}</div>
        </div>
    </div>
    @endif
