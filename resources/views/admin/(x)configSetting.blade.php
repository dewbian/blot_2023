...
<!-- form start -->
<form action="{{ url('/admin/setting') }}" method="post" class="form-horizontal model-form-6376f79aeab3a" 
        ...
        <div class="col-md-12">
            <div class="form-group  ">
                ...
                <div class="col-sm-8">
                    ...
                    <input type="text" id="cf_title" name="cf_title" value="{{ $cf_title }}" class="form-control username" placeholder="홈페이지 제목">
                    </div>
                </div>
            </div>
            <div class="form-group  ">
                ...
                <div class="col-sm-8">
                    <div class="input-group"><span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                    <input type="text" id="cf_admin_email" name="cf_admin_email" value="{{ $cf_admin_email}}" class="form-control name" placeholder="xxx@xxx.xx">
            ...
            <div class="form-group  ">
                ...
                <div class="col-sm-8">
                    <div class="input-group"><span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                    <input type="text" id="cf_admin_email_name" name="cf_admin_email_name" value="{{ $cf_admin_email_name}}" class="form-control name" placeholder="입력 이름">
                    </div> 
